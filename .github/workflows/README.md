...
- HOST_DOMAIN - Domain/sub-domain of your application, eg `ppmrm-rewrite.example.com` .
...
gh secret set AWS_ECS_CLUSTER -b"<AWS_ECS_CLUSTER, eg ppmrm-rewrites>"
gh secret set HOST_DOMAIN -b"<HOST_DOMAIN, eg ppmrm-rewrite.example.com>"
