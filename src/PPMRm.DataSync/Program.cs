namespace PPMRm.DataSync
{
    ...
    class Program
    {
        public const string ConnectionString = "Host=localhost;Port=5432;Database=ppmrm_april;User ID=postgres;Password=mysecretpassword;";
        ...
        private static void DefineProcess(ISingleStream<string> contextStream)
        {
            var orderStream = contextStream
                .CrossApplyFolderFiles("list all required files", "202303*.tar.gz", true)
