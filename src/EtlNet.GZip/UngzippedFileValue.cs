...
{
    public class UngzippedFileValue<TMetadata> : FileValueBase<TMetadata> where TMetadata : IFileValueMetadata
    {
        ...
        public UngzippedFileValue(Stream stream, string name, TMetadata metadata, IFileValue underlyingFileValue, HashSet<string> pathsNotFlaggedForDelete, string innerPath)
